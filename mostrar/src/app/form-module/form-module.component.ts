  ...
  export class FormModuleComponent implements OnInit{
    ...
    loadForm(): void {
      this.serviceModuleFormGeneric.get<{ id: number, name: string }[]>('FormControllerPrueba').subscribe({
        next: data => {
    ...
    loadModules(): void {
      this.serviceModuleFormGeneric.get<{ id: number, name: string }[]>('Module').subscribe({
        next: data => {
    ...
    updateFormModule(): void {
      ...
      this.serviceModuleFormGeneric.put<form_Module>('FormModule', this.currentFormModule).subscribe({
        next: () => {
          this.loadFormModules();
          this.resetFormModule();
        },
